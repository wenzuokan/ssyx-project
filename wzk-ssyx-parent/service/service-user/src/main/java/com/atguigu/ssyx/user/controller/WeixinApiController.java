...
public class WeixinApiController {
    ...
    public Result loginWx(@PathVariable String code) {
        ...
        try {
            ...
            throw new WzkException(ResultCodeEnum.FETCH_ACCESSTOKEN_FAILD);
        }

        //3 请求微信接口服务，返回两个值session_key 和 openId
        ////openId是你微信唯一标识
        ...
        //6 使用JWT工具工具userId和userName生成token字符串
